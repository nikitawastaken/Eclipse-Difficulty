Hooks:PostHook(FireTweakData, "init", "eclipse_init", function(self)
	...
	self.dot_entries.fire.ammo_flamethrower_mk2_rare.dot_damage = 7.2

	self.dot_entries.fire.ammo_flamethrower_mk2_welldone = clone(self.dot_entries.fire.weapon_flamethrower_mk2)
	self.dot_entries.fire.ammo_flamethrower_mk2_welldone.dot_damage = 2.4
	...
	self.dot_entries.fire.weapon_money.dot_damage = 1.2
	...
	self.dot_entries.fire.ammo_dragons_breath_light.dot_damage = 2.4
	...
	self.dot_entries.fire.ammo_dragons_breath_heavy.dot_damage = 4.8
	...
	self.dot_entries.fire.proj_launcher_incendiary.dot_damage = 2.4
