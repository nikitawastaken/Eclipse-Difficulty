Hooks:PostHook(FireTweakData, "init", "eclipse_init", function(self)
	...
	self.dot_entries.fire.ammo_flamethrower_mk2_rare.dot_damage = 3.6

	self.dot_entries.fire.ammo_flamethrower_mk2_welldone = clone(self.dot_entries.fire.weapon_flamethrower_mk2)
	self.dot_entries.fire.ammo_flamethrower_mk2_welldone.dot_damage = 1.2

	self.dot_entries.fire.ammo_dragons_breath.dot_damage = 1.2
	...
	self.dot_entries.fire.ammo_dragons_breath_light.dot_damage = 1.2
	...
	self.dot_entries.fire.ammo_system_high.dot_damage = 3.6

	self.dot_entries.fire.ammo_system_low = clone(self.dot_entries.fire.weapon_system)
	self.dot_entries.fire.ammo_system_low.dot_damage = 1.2
	...
	self.dot_entries.fire.proj_molotov.dot_damage = 3.6
	...
	self.dot_entries.fire.proj_launcher_incendiary.dot_damage = 1.2
	...
	self.dot_entries.fire.proj_launcher_incendiary_light.dot_damage = 1.2
	...
	self.dot_entries.fire.proj_launcher_incendiary_medium.dot_damage = 2.4
