...
function PlayerBase:set_suspicion_multiplier(reason, multiplier)
	...
	Eclipse:log_chat("PlayerBase: Set suspicion multiplier for reason '" .. reason .. "' to " .. multiplier .. ". New buildup multiplier is " .. buildup_mul .. " and new range multiplier is " .. range_mul)
end