...
-- Dominating a guard in stealth no longer makes him cuff himself immediately. The interaction is now the same as in loud.
...
function CopLogicIntimidated._chk_begin_alarm_pager() end