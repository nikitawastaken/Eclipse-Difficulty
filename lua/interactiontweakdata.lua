...
Hooks:PostHook(InteractionTweakData, "init", "eclipse_init", function(self)
	...
	self.pex_hook_car.sound_start = "bar_attach_money_stack"
	self.pex_hook_car.sound_interupt = "bar_attach_money_stack_cancel"
	self.pex_hook_car.sound_done = "bar_attach_money_stack_finished"
