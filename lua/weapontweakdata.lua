...
-- Scout
self.scout.stats.damage = 147
self.scout.AMMO_MAX = total_ammo_tables.secondary_sniper
self.scout.AMMO_PICKUP = pickup_tables.secondary_sniper
self.scout.kick.standing = self.msr.kick.standing
self.scout.kick.crouching = self.msr.kick.crouching
self.scout.kick.steelsight = self.msr.kick.steelsight
...
self.m16.kick.standing = {1.4, 1.65, -1.15, 1.15}
...
self.olympic.kick.standing = {1.6, 1.9, -1.2, 1.2}
...
self.vityaz.kick.standing = {1.6, 1.9, -1.2, 1.2}
...
self.hajk.kick.standing = {1.6, 1.9, -1.2, 1.2}
...
self.uzi.kick.standing = {1.4, 1.6, -1, 1}
...
self.akmsu.kick.standing = {1.6, 1.9, -1.2, 1.2}
...
-- Frenchman
self.model3.AMMO_MAX = total_ammo_tables.pistol_very_low
self.model3.AMMO_PICKUP = pickup_tables.pistol_very_low
...
self.ray.AMMO_PICKUP = {0.033, 0.033}
...
self.rpg7.AMMO_PICKUP = {0.033, 0.033}

-- Piglet
self.m32.stats.damage = 42
self.m32.AMMO_PICKUP = {0.056, 0.056}
