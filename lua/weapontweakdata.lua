...
Hooks:PostHook(WeaponTweakData, "init", "eclipse_init", function(self, tweak_data)
	...
	self.sub2000.stats.spread = 17
	self.sub2000.stats.recoil = 11
	...
	self.desertfox.stats.damage = 30
