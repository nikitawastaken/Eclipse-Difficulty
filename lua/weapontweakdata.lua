...
function WeaponTweakData:_init_weapons()
	...
	for weap_id, weap_data in pairs(self) do
		...
		elseif cat_map.shotgun then
			...
			weap_data.damage_near = weap_data.damage_near or 2000
			weap_data.damage_far = weap_data.damage_far or 3000
			weap_data.rays = 8
...
Hooks:PostHook(WeaponTweakData, "init", "eclipse_init", function(self, tweak_data)
	...
	self.groza.stats.concealment = 12
	...
	self.hailstorm.fire_mode_data.volley.spread_mul = 3
	...
	self.kacchainsaw_flamethrower.stats.damage = 18
