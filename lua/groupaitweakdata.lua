...
Hooks:PostHook(GroupAITweakData, "_init_enemy_spawn_groups", "eclipse__init_enemy_spawn_groups", function(self, difficulty_index)
	...
	self._random_tactics = {
		...
		bulldozer = { self._tactics.bulldozer_init, self._tactics.bulldozer_agg },
	...
	local medic_taser = { "medic_1", "medic_2", "taser" }
		...
		spawn = {
			{
				...
				rank = 2,
				unit = "taser",
				tactics = self._random_tactics.taser,
			},
			{
				freq = 1,
				rank = 1,
		...
		spawn = {
			{
				...
				rank = 3,
				unit = "bulldozer_1",
				tactics = self._random_tactics.bulldozer,
			},
			{
				amount_min = 2,
				freq = 1,
		...
		spawn = {
			{
				...
				rank = 1,
				unit = "cloaker",
				tactics = self._random_tactics.cloaker,
			},
		},
	}
...
Hooks:PostHook(GroupAITweakData, "_init_task_data", "eclipse__init_task_data", function(self, difficulty_index)
	...
	elseif difficulty_index == 4 then
		self.ponr.assault.groups = {
			elite_swats_ranged = { 30, 30, 30 },

			fbi_heavies_charge = { 30, 30, 30 },
	...
	elseif difficulty_index == 5 then
		...
		self.ponr.assault.groups = {
			elite_swats_ranged = { 20, 20, 20 },

			elite_heavies_charge = { 40, 40, 40 },
