...
Hooks:PostHook(GroupAITweakData, "_init_enemy_spawn_groups", "eclipse__init_enemy_spawn_groups", function(self, difficulty_index)
	...
	self.enemy_spawn_groups.cs_shield = {
		...
		spawn = {
			...
			{
				freq = 0.5 * (heavy_response and 0.5 or small_urban and 2 or 1),
				rank = 2,
				unit = "cs_swat",
				tactics = self._tactics.shield_support,
			},
			{
				freq = 1 * (small_urban and 0.5 or 1),
				rank = 2,
				unit = "cs_heavy",
				tactics = self._tactics.shield_support,
			},
	...
	self.enemy_spawn_groups.fbi_stealth_heavy = {
		...
		spawn = {
			...
			{
				freq = (difficulty_index ^ 2) / 60 * (skyscraper and 1.25 or 1),
				amount_max = 1,
				rank = 1,
				unit = "taser",
	...
	self.enemy_spawn_groups.fbi_shield = {
		...
		spawn = {
			{
				freq = (difficulty_index ^ 2) / 60 * (heavy_response and 1.25 or small_urban and 0.5 or 1),
				amount_min = 1,
				amount_max = 2,
				rank = 3,
				unit = "fbi_shield",
...
Hooks:PostHook(GroupAITweakData, "_init_task_data", "eclipse__init_task_data", function(self, difficulty_index)
	...
	elseif difficulty_index == 4 then
		...
		self.besiege.recon.groups = {
			fbi_stealth_light = { 1, 1, 1 },
			fbi_stealth_heavy = { 0, 1, 3 },
		}
		self.besiege.reenforce.groups = {
			cs_defend_init = { 1, 0, 0 },
			cs_defend_light = { 1, 2, 0 },
