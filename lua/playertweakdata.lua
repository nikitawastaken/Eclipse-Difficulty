...
Hooks:PostHook(PlayerTweakData, "init", "eclipse__init", function(self)
	...
	self.damage.automatic_respawn_time = 180 + (is_eclipse and 60 or is_overkill and 30 or 0) + (is_pro_job and 60 or 0)
...
Hooks:PostHook(PlayerTweakData, "_init_new_stances", "eclipse_init_new_stances", function(self)
	...
	local pivot_head_translation = Vector3(0, 15, 0) -- 8, 10, -1
