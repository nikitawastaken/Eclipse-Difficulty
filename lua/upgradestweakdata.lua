...
function UpgradesTweakData:_init_pd2_values(tweak_data)
	...
	self.values.player.body_armor = {
		...
		regen_timer = { 3, 3.25, 3.5, 3.75, 4, 4.5, 5 },
...
function UpgradesTweakData:init(tweak_data)
	...
	self.values.weapon.consume_no_ammo_chance = { { normal = 0.05, low_ammo = 0.2, low_ammo_threshold = 3 } }
	...
	-- Big Game Hunters
	self.values.temporary.double_drop_damage_multiplier = { { 1.25, 8 } }
	...
	self.specialization_descs[1][7].multiperk2 = "4"
