Hooks:PostHook(DOTTweakData, "init", "eclipse_init", function(self)
	...
	self.dot_entries.poison.proj_launcher_poison = clone(self.dot_entries.poison.proj_gas_grenade_cloud)
	self.dot_entries.poison.proj_launcher_poison.dot_damage = 2
