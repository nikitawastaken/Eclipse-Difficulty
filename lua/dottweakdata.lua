Hooks:PostHook(DOTTweakData, "init", "eclipse_init", function(self)
	...
	self.dot_entries.poison.ammo_rip_light.dot_damage = 1.2
	...
	self.dot_entries.poison.ammo_rip_medium.dot_damage = 1.8
	...
	self.dot_entries.poison.ammo_rip_heavy.dot_damage = 2.4
	...
	self.dot_entries.poison.proj_gas_grenade_cloud.dot_damage = 0.8
