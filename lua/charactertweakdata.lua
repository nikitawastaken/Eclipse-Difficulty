...
function CharacterTweakData:_presets(tweak_data, ...)
	...
	presets.weapon.tank.is_shotgun_mag.FALLOFF = {
		{ dmg_mul = 9 * dmg_mul, r = 0, acc = { 0.6, 0.9 }, recoil = { 0.4, 0.7 }, mode = { 1, 0, 0, 0 }, autofire_rounds = { 5, 6 } },
		{ dmg_mul = 6 * dmg_mul, r = 1000, acc = { 0.5, 0.8 }, recoil = { 0.45, 0.8 }, mode = { 1, 0, 0, 0 }, autofire_rounds = { 3, 4 } },
