...
-- Add headshot and body impact effects effects
function CopDamage:_play_impact_effect(attack_data, effect, sound)
	if effect then
...
Hooks:OverrideFunction(CopDamage, "damage_melee", function(self, attack_data)
	...
	if self._health <= damage then
		if head then
			...
			self:_play_impact_effect(attack_data, head_effect_id, head_sound_id)
		end
	end
