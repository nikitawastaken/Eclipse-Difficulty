function PlayerEquipment:use_first_aid_kit()
	...
	if ray then
		...
		local bits = Bitwise:lshift(auto_recovery, FirstAidKitBase.auto_recovery_shift) + Bitwise:lshift(upgrade_lvl, FirstAidKitBase.upgrade_lvl_shift) + Bitwise:lshift(hot_regen, FirstAidKitBase.hot_regen_shift)
