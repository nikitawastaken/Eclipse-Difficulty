...
local optsGarageNavlinkVertical01 = get_navlink_so_opts("e_nl_up_0_5m_dwn_9m", Vector3(400, 850, -350), 20)
local optsGarageNavlinkVertical02 = get_navlink_so_opts("e_nl_up_0_5m_dwn_9m", Vector3(1000, 850, -350), 20)
local optsGarageNavlinkVertical03 = get_navlink_so_opts("e_nl_up_0_5m_dwn_9m", Vector3(400, 1370, -350), 20)
local optsGarageNavlinkVertical04 = get_navlink_so_opts("e_nl_up_0_5m_dwn_9m", Vector3(1000, 1370, -350), 20)
