...
local optsOpenSwatSpawnVanDoors = {
	...
	trigger_list = {
		...
		{ id = 1, name = "run_sequence", notify_unit_id = 102582, notify_unit_sequence = "door_open_left_back", time = 0 },
		{ id = 2, name = "run_sequence", notify_unit_id = 102582, notify_unit_sequence = "door_open_right_back", time = 0 },
		{ id = 3, name = "run_sequence", notify_unit_id = 102583, notify_unit_sequence = "door_open_left_back", time = 0 },
		{ id = 4, name = "run_sequence", notify_unit_id = 102583, notify_unit_sequence = "door_open_right_back", time = 0 },
		{ id = 1, name = "run_sequence", notify_unit_id = 102584, notify_unit_sequence = "door_open_left_back", time = 0 },
		{ id = 2, name = "run_sequence", notify_unit_id = 102584, notify_unit_sequence = "door_open_right_back", time = 0 },
		{ id = 3, name = "run_sequence", notify_unit_id = 102585, notify_unit_sequence = "door_open_left_back", time = 0 },
		{ id = 4, name = "run_sequence", notify_unit_id = 102585, notify_unit_sequence = "door_open_right_back", time = 0 },
		{ id = 1, name = "run_sequence", notify_unit_id = 102586, notify_unit_sequence = "door_open_left_back", time = 0 },
