...
M.elements = {
	...
	Eclipse.mission_elements.gen_dummy(400006, "haunted_spawn_enemy006", Vector3(-1625, 3300, -400), Rotation(0, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_dummy(400007, "haunted_spawn_enemy007", Vector3(-1700, 3300, -400), Rotation(0, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_dummy(400008, "haunted_spawn_enemy008", Vector3(-1775, 3300, -400), Rotation(0, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_dummy(400009, "haunted_spawn_enemy009", Vector3(-1850, 3300, -400), Rotation(0, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_dummy(400010, "haunted_spawn_enemy010", Vector3(-1925, 3300, -400), Rotation(0, 0, 0), optsBesiegeDummy_1),
	...
	Eclipse.mission_elements.gen_dummy(400018, "haunted_spawn_enemy016", Vector3(-1125, 2400, -400), Rotation(0, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_dummy(400019, "haunted_spawn_enemy017", Vector3(-1200, 2400, -400), Rotation(0, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_dummy(400020, "haunted_spawn_enemy018", Vector3(-1275, 2400, -400), Rotation(0, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_dummy(400021, "haunted_spawn_enemy019", Vector3(-1350, 2400, -400), Rotation(0, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_dummy(400022, "haunted_spawn_enemy020", Vector3(-1425, 2400, -400), Rotation(0, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_spawngroup(400023, "haunted_enemy_group004", { 400018, 400019, 400020, 400021, 400022 }, 0),

	Eclipse.mission_elements.gen_dummy(400024, "haunted_spawn_enemy021", Vector3(-950, 2825, -400), Rotation(-90, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_dummy(400025, "haunted_spawn_enemy022", Vector3(-950, 2900, -400), Rotation(-90, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_dummy(400026, "haunted_spawn_enemy023", Vector3(-950, 2975, -400), Rotation(-90, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_dummy(400027, "haunted_spawn_enemy024", Vector3(-950, 3050, -400), Rotation(-90, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_dummy(400028, "haunted_spawn_enemy025", Vector3(-950, 3125, -400), Rotation(-90, 0, 0), optsBesiegeDummy_1),
	Eclipse.mission_elements.gen_spawngroup(400029, "haunted_enemy_group005", { 400024, 400025, 400026, 400027, 400028 }, 0),

	Eclipse.mission_elements.gen_dummy(400030, "haunted_spawn_enemy026", Vector3(-3100, 3750, -400), Rotation(-90, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_dummy(400031, "haunted_spawn_enemy027", Vector3(-3100, 3825, -400), Rotation(-90, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_dummy(400032, "haunted_spawn_enemy028", Vector3(-3100, 3900, -400), Rotation(-90, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_dummy(400033, "haunted_spawn_enemy029", Vector3(-3100, 3975, -400), Rotation(-90, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_dummy(400034, "haunted_spawn_enemy030", Vector3(-3100, 4050, -400), Rotation(-90, 0, 0), optsBesiegeDummy_2),
	Eclipse.mission_elements.gen_spawngroup(400035, "haunted_enemy_group006", { 400030, 400031, 400032, 400033, 400034 }, 0),

	Eclipse.mission_elements.gen_dummy(400036, "haunted_spawn_enemy031", Vector3(-3350, 1300, 0), Rotation(90, 0, 0), optsBesiegeDummy_3),
	Eclipse.mission_elements.gen_dummy(400037, "haunted_spawn_enemy032", Vector3(-3350, 1225, 0), Rotation(90, 0, 0), optsBesiegeDummy_3),
	Eclipse.mission_elements.gen_dummy(400038, "haunted_spawn_enemy033", Vector3(-3350, 1150, 0), Rotation(90, 0, 0), optsBesiegeDummy_3),
	Eclipse.mission_elements.gen_dummy(400039, "haunted_spawn_enemy034", Vector3(-3350, 1075, 0), Rotation(90, 0, 0), optsBesiegeDummy_3),
	Eclipse.mission_elements.gen_dummy(400040, "haunted_spawn_enemy035", Vector3(-3350, 1000, 0), Rotation(90, 0, 0), optsBesiegeDummy_3),
	Eclipse.mission_elements.gen_spawngroup(400041, "haunted_enemy_group007", { 400036, 400037, 400038, 400039, 400040 }, 0),

	Eclipse.mission_elements.gen_dummy(400042, "haunted_spawn_enemy036", Vector3(-4300, 2500, 0), Rotation(180, 0, 0), optsBesiegeDummy_4),
	Eclipse.mission_elements.gen_dummy(400043, "haunted_spawn_enemy037", Vector3(-4225, 2500, 0), Rotation(180, 0, 0), optsBesiegeDummy_4),
	Eclipse.mission_elements.gen_dummy(400044, "haunted_spawn_enemy038", Vector3(-4150, 2500, 0), Rotation(180, 0, 0), optsBesiegeDummy_4),
	Eclipse.mission_elements.gen_dummy(400045, "haunted_spawn_enemy039", Vector3(-4075, 2500, 0), Rotation(180, 0, 0), optsBesiegeDummy_4),
	Eclipse.mission_elements.gen_dummy(400046, "haunted_spawn_enemy040", Vector3(-4000, 2500, 0), Rotation(180, 0, 0), optsBesiegeDummy_4),
