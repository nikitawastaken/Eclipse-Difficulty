...
local group_type_mapping = {
	...
	Elite_assault_heavies = "heavy_group",
	...
	FBI_recon_cloaker = "cloaker_group",
...
M.only_swats_heavies_tasers = create_preferred({ "cop_group", "agent_group", "shield_group", "bulldozer_group", "cloaker_group", "sniper_group" })
