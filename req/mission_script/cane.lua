...
return {
	...
	[101043] = { -- 1 wave passed
		on_executed = {
			{ id = 101367, delay = 0, delay_rand = 20 }, -- back basic
		},
	},
	[101152] = { -- 2 waves passed
		on_executed = {
			{ id = 101427, delay = 0, delay_rand = 20 }, -- side basic
			{ id = 400038, delay = 0, delay_rand = 20 }, -- eclipse front buildings
		},
	},
	[101153] = { -- 3 waves passed
		on_executed = {
			{ id = 101536, delay = 0, delay_rand = 20 }, -- roof basics
		},
	},
