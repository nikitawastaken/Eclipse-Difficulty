...
local M = {
	...
	["units/pd2_dlc1/characters/ene_gensec_operator_1/ene_gensec_operator_1"] = { name = "gensec_operator_1", head = head_sequences.blue_swat_a },
	["units/pd2_dlc1/characters/ene_gensec_operator_2/ene_gensec_operator_2"] = { name = "gensec_operator_1", head = head_sequences.blue_swat_a },
